...
>
	...
	{:else if variant === 'history-list'}
		<div class="list-search-bar list-search-bar--sticky workouts-history-tools workouts-history-tools--skeleton" aria-hidden="true">
			<div class="list-search-bar__row">
				...
				<span class="list-search-bar__filter workouts-skeleton-filters-btn"></span>
			</div>
		</div>
