...
const cases: Array<{ label: string; input: Parameters<typeof resolveHomeSkeletonVariant>[0]; want: 'create' | 'start' }> =
	[
		{
		...
		{
			label: 'guest without plans',
			input: { accountBoot: false, homeBoot: 'create', authReady: true, hasUser: false, hasPlans: false },
			want: 'create'
		},
		{
