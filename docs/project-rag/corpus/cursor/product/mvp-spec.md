<!-- source: .cursor/product/mvp-spec.md -->
<!-- synced: 2026-09-23 -->
...
**MVP = UX священного цикла**, не каталог фич. Успех: цикл ощущается великолепно на телефоне в зале. Канал доставки - мобильный PWA. Legal: `/privacy` + `/terms`, consent на signup/magic, веб-аналитика opt-in.
